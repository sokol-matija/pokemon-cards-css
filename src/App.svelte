<script>
  import { onMount } from "svelte";
	...
	import RestaurantFlipCard from "./lib/components/RestaurantFlipCard.svelte";
	import { activeRestaurantCard } from "./lib/components/activeRestaurantCard.js";
	import BurgerCard from "./lib/components/BurgerCard.svelte";
	import ExactBurgerCard from "./lib/components/ExactBurgerCard.svelte";
	import SimpleBurgerFlipCard from "./lib/components/SimpleBurgerFlipCard.svelte";
	import { activeBurgerCard } from "./lib/stores/activeBurgerCard.js";
	import { exactBurgerCard } from "./lib/stores/exactBurgerCardStore.js";
...
<main>
	<header>
		...
		<nav style="margin-bottom: 1em;">
			<button on:click={() => showRestaurantCard = !showRestaurantCard} style="font-size:1.1em;padding:0.5em 1.2em;border-radius:8px;background:linear-gradient(90deg,#0dbde9,#eedf10,#f80e35);color:#222;font-weight:bold;border:none;cursor:pointer;box-shadow:0 2px 8px #0003;">
				{showRestaurantCard ? 'Hide' : 'Show'} Custom Restaurant Card Demo
			</button>
		</nav>
	...
	{#if showRestaurantCard}
		<section style="margin: 2em 0; display: flex; flex-direction: column; align-items: center; gap: 3em;">
			<div>
				<h3 style="text-align:center;margin-bottom:1em;">Previous Card (Popover + Flip)</h3>
				<RestaurantCard />
			</div>
			<div>
				<h3 style="text-align:center;margin-bottom:1em;">Basic Flip Card (No Popover)</h3>
				<RestaurantFlipCard />
			</div>
			<div>
				<h3 style="text-align:center;margin-bottom:1em;">New Burger Card (Pokémon Style Implementation)</h3>
				<BurgerCard />
			</div>
			<div>
				<h3 style="text-align:center;margin-bottom:1em;">Exact Pokemon Clone with Burger Images (Popover Only)</h3>
				<ExactBurgerCard name="Monster Burger" price="$12.99" front="/img/burger.png" />
			</div>
			<div>
				<h3 style="text-align:center;margin-bottom:1em;">Simple Burger Flip Card (Flip Only)</h3>
				<SimpleBurgerFlipCard name="Simple Flip Burger" price="$8.99" front="/img/burger.png" />
			</div>
		</section>
	{/if}
